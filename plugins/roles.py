...
@bot.message_handler( func=lambda message: message.text in ['CAMPEÕES','BOHATEROWIE','CAMPEONES','CHAMPIONS','CAMPIONI'])
...
@bot.message_handler( func=lambda message: message.text in ['PAPÉIS','ROLE','POSICIONES','ROLES','RUOLI','ROLLEN','RÔLES'])
